...
class vtn_acerca(wx.Frame):
    ...
    def __init__(self,parent,title):
        ...
        wx.Frame.__init__(self,parent=parent,title=title,size=(250,200),style=estilo)
        
        icono = wx.Icon('Icono.ico')
        
        self.SetIcon(icono)
        
        wx.StaticText(self,label= "Extractor SIRADIG Versión 1.1",pos=(8,11))
        ...
        wx.StaticText(self,label="Año, 2021 - Buenos Aires, Argentina",pos=(8,84))
        
        btnCerrar = wx.Button(self,-1,label='Cerrar',pos=(148,116),size=(78,32))
        btnLinkedIn = wx.Button(self,-1,label='LinkedIn',pos=(60,116),size=(78,32))
    ...
    def onLinkedIn(self,event):
        webbrowser.open("http://www.linkedin.com/in/jorge-e-arrieta/", new=2, autoraise=True)
...
if __name__=="__main__":
    app=wx.App()
    frame = principal(None,"Extractor SIRADIG")
